...
import afluex.mlm.demo.responseProductDetails.LstflavourItem;
import butterknife.BindView;
import butterknife.ButterKnife;

public class AdapterFlavoue extends RecyclerView.Adapter<AdapterFlavoue.MyViewHolder> {

    private Context context;
    private List<LstflavourItem> productList;
    SelectedVarientsListener listener;

    public AdapterFlavoue(Context mContext, List<LstflavourItem> productList, SelectedVarientsListener listener) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.tvCategory.setText(productList.get(position).getFlavorName());
        ...
        holder.tvCategory.setOnClickListener(view -> {
            if (!productList.get(position).getStatus().contains("selected"))
                listener.selectedVarients("", "", productList.get(position).getFlavorID(), "", "", "");
        });
    }
