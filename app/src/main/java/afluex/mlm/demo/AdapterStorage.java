...
import afluex.mlm.demo.responseProductDetails.LststorageItem;
import butterknife.BindView;
import butterknife.ButterKnife;

public class AdapterStorage extends RecyclerView.Adapter<AdapterStorage.MyViewHolder> {

    private Context context;
    private List<LststorageItem> productList;
    SelectedVarientsListener listener;

    public AdapterStorage(Context mContext, List<LststorageItem> productList, SelectedVarientsListener listener) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.tvCategory.setText(productList.get(position).getStorageName());
        ...
        holder.tvCategory.setOnClickListener(view -> {
            if (!productList.get(position).getStatus().contains("selected"))
                listener.selectedVarients("", "", "", "", "", productList.get(position).getStorageID());
        });
    }
